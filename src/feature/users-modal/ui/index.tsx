...
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger } from "@/shared/ui/select";
      ...
      <ScrollArea className="h-[400px]"> 
        <div className="space-y-2 pr-2">
          {usersData.map((u: UserWithRoleType) => (
            <Item key={u.id} variant="muted">
              <ItemMedia>
                ...
                >
                  ...
                  <AvatarFallback className="bg-primary">{u.fallback}</AvatarFallback>
                </Avatar>
              </ItemMedia>
            ...
            <Button variant="outline" size="icon"><UserRoundX /></Button>
            </ItemActions>
